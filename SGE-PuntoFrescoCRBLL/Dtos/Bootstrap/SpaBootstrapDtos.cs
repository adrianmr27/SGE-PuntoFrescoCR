...
public class PedidoLineaClienteDto { public string Producto { get; set; } = ""; public string Categoria { get; set; } = ""; public int Cantidad { get; set; } public decimal Total { get; set; } }
public class PedidoClienteDto { public int PedidoId { get; set; } public string Id { get; set; } = ""; public string Cliente { get; set; } = ""; public string Fecha { get; set; } = ""; public decimal Total { get; set; } public string Estado { get; set; } = ""; public int Items { get; set; } public List<PedidoLineaClienteDto> Lineas { get; set; } = new(); }
